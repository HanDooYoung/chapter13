...
public class Ex13_08 {
	static class MyGUI extends JFrame{
		MyGUI(){
			...
			ImageIcon img1=new ImageIcon("/Users/h/스밋코구라시png/스밋코be (2).png");
			ImageIcon img2=new ImageIcon("/Users/h/스밋코구라시png/스밋코be (3).png");
			
			JButton btn1=new JButton("버튼2",img1);
			this.add(btn1);
